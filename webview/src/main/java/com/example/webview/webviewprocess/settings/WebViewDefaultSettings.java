...
public class WebViewDefaultSettings {
    ...
    private static volatile WebViewDefaultSettings mWebViewSettings;
    ...
    public static WebViewDefaultSettings getInstance() {
        if (mWebViewSettings == null) {
            synchronized (WebViewDefaultSettings.class) {
                if (mWebViewSettings == null) {
                    mWebViewSettings = new WebViewDefaultSettings();
                }
            }
        }
        return mWebViewSettings;
    }
